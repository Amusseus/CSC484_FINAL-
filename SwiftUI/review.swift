  ...
  var body: some View {
    ZStack() {
      ZStack() {
        ...
        .frame(width: 35, height: 35)
        .offset(x: 121, y: -75.50)
      }
      .frame(width: 393, height: 570)
      .offset(x: 0, y: -141)
      Rectangle()
        .foregroundColor(.clear)
      ...
      ZStack() {
        ...
        Text("Choose class")
          .font(Font.custom("Viga", size: 18))
          .foregroundColor(Color(red: 0.08, green: 0.28, blue: 0.20).opacity(0.50))
          .offset(x: -71, y: -121.50)
        Text("Write review here")
          .font(Font.custom("Viga", size: 18))
          .foregroundColor(Color(red: 0.08, green: 0.28, blue: 0.20).opacity(0.50))
          .offset(x: -67.50, y: -17.50)
      }
      .frame(width: 330, height: 454)
      .offset(x: 1.50, y: 108)
      Rectangle()
        .foregroundColor(.clear)
